                                  ...
                                  <div class="col-sm-9">
                                    ...
                                    $row=mysqli_fetch_assoc($datos);
                                       ?>
                                          <p class="col-sm-2 col-sm-2 control-label">Nombre:&emsp; </p>
                                           <div class="col-sm-9">
                                           <input type="text" class="form-control" disabled="true" name="p_nom" value="<?php echo $row['nombre_usuario']." ".$row['ap_paterno_usuario']; ?>"> </input>
                                           </div>
                                            <p class="col-sm-2 col-sm-2 control-label">CI:&emsp; </p>
                                           <div class="col-sm-9">
                                           <input type=""  class="form-control" disabled="true" name="p_ci"  value="<?php echo $row['ci_usuario']; ?>"> </input>
                                           </div>
                                           <?php
                                       ?>
                                  </div>
