...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 14-11-2017 a las 09:53:52
...
(1, 'deposito mercantil', 1, 3000, 3000, 0, 1, 1111),
(2, 'deposito mercantil', 1, 3000, 0, 3000, 1, 1132),
(3, 'deposito estado', 1, 1000, 1000, 0, 1, 1111),
(4, 'deposito estado', 1, 1000, 0, 1000, 1, 1131),
(5, 'asdasd', 1, 10000, 10000, 0, 2, 1111),
(6, 'asdasd', 1, 10000, 0, 10000, 2, 1132),
(7, 'adfadfasdf', 1, 12000, 12000, 0, 3, 1131),
(8, 'adfadfasdf', 1, 12000, 0, 12000, 3, 1111),
(9, 'dfajskdhfks', 10000, 10000, 0, 10000, 4, 1131),
(10, 'dfajskdhfks', 10000, 10000, 10000, 0, 4, 1111);
...
(2, 3, 2, 'ACTIVO', 'secre', 'secre'),
(3, 2, 3, 'ACTIVO', 'conta', 'conta');
...
(1, 'Instituto Superior de Estudios TecnolÃ³gicos  \"Nuestra SeÃ±ora de La Paz \" ', 'Av. Armentia # 511', 2281900, 2281901, 'La Paz');
...
(1, 1, '2017-11-14', '10:52:31', 8000, 8000, 0, 1, 108, 1, 14),
(2, 45, '2017-11-14', '11:07:37', 20000, 20000, 0, 1, 108, 1, 15),
(3, 45, '2017-11-14', '11:12:39', 24000, 24000, 0, 1, 108, 1, 16),
(4, 12321, '2017-11-14', '10:26:08', 10000, 0, 10000, 2, 103, 3, 9);
...
(1, 2017, '2017-11-01', '2017-11-30', 1);
...
(2, 'secre', 8, 'Recibio'),
(3, 'secre', 8, 'Recibio'),
(4, 'Cinthia Alvarez', 1231231, 'Recibio'),
(5, 'juan ', 233332222, 'Recibio'),
(6, 'Ana', 98, 'Recibio'),
(7, 'f', 3421, 'Recibio'),
(8, 'Ana', 123, 'Recibio'),
(9, 'ana', 14785, 'Recibio'),
(10, 'ana', 74411, 'Recibio'),
(11, 'ana', 2424344, 'Recibio'),
(12, 'sdsd', 57, 'Recibio'),
(13, 'gdfgg', 675756, 'Recibio'),
(14, 'fd', 3424, 'Recibio'),
(15, 'adfs', 1232, 'Recibio'),
(16, 'afadsf', 224141, 'Recibio');
...
(1111, 'Caja moneda Nacional', 'ACTIVO', '2017-11-14', NULL, 111),
...
(1, 'Wendy', 'Guzman', 'Rojas', 1234567),
(2, 'Cinthia', 'Alvarez', 'De la Torre', 9876543),
