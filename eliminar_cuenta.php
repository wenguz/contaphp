...
$id_cuenta = htmlentities($_GET['cu']);
      ...
      <!-- page start-->
              <section class="panel">
                  <div class="panel-body">  
                    <h4 class="mb"><i class="fa fa-angle-right"></i><a href="lista_cuenta.php"> Lista de cuentas</a> &emsp;<i class="fa fa-angle-right"></i>  Cuenta </h4>
                      <center><label style="font-size: 24px">CUENTA</label></center><br>
                        ...
                        <tr>
                          ...
                          <td width="80%">
                            <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  <input type="text" class="form-control" name="cod_clase" value="<?=$row['id_cuenta']?>">
                              </div>
                            </div>
                            <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Nombre_de_Cuenta: </label>
                              <div class="col-sm-10">
                                  <input type="text" class="form-control" name="nom_clase" value="<?=$row['nombre_cuenta']?>">
                              </div>
                            </div>
                          </td>
                          <td width="10%"></td>
                      ...
                      <center>
                        <br>
                          <?php
                            $dato_estado_cuenta=mysqli_query($con,"SELECT estado_cuenta from cuenta where id_cuenta='$id_cuenta'");
                            $rowsss = mysqli_fetch_assoc($dato_estado_cuenta);
                            if($rowsss['estado_cuenta']=='ACTIVO') 
                            { 
                                ?>
                                &emsp;<input type="submit" class="btn btn-success" name="desactivar_cuenta" value="Deshabilitar cuenta">
                                &emsp;
                                <?php
                            } 
                            else
                            {
                                ?>
                                &emsp;<input type="submit" class="btn btn-success" name="activar_cuenta" value="Habilitar cuenta">
                                &emsp;
                                <?php
                            }
                          ?>
                       ...
                       <?php
                        ...
                        { 
                            $sql =("UPDATE cuenta SET estado_cuenta='NO ACTIVO' WHERE id_cuenta='$id_cuenta'");
                            mysqli_query($con,$sql) or die(mysqli_error());

                            $msg = "cuenta Deshabilitada correctamente";
                        ...
                        { 
                            ...
                            $sql =("UPDATE cuenta SET estado_cuenta='ACTIVO' WHERE id_cuenta='$id_cuenta'");
                            mysqli_query($con,$sql) or die(mysqli_error());
