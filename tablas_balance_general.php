...
function ChapterTitle($label)
{
    ...
    // Título
    $this->Cell(0,6,"BALANCE GENERAL",0,1,'C');
...
$header1=array('CODIGO','CUENTA', 'DEBE','HABER','SALDO');
//$header = array('NRO','DETALLE','DEBE','HABER','DEUDOR','ACREEDOR');

// Carga de datos
$data = $pdf->LoadData('balance_general.txt');
