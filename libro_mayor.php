        ...
        <li class="sub-menu">
          ...
          <li class="sub-menu">
            <a class="active" href="javascript:;" >
              ...
              <ul class="sub">
                  <li class="active" ><a  href="libro_mayor.php"><i class="fa fa-list-alt"></i>Libro Mayor</a></li>
              </ul>
          </li>
          <li class="sub-menu">
            <a  href="javascript:;" >
              ...
              <ul class="sub">
                  <li ><a  href="reporte_sumas_y_resultados.php"><i class="fa fa-list-alt"></i>Reporte Sum y res</a></li>
          ...
          <div class="col-md-12">
              <div class="content-panel" >
                  <table class="table table-bordered table-striped table-condensed">
                    ...
                    &emsp;<label>Mostrar informe del mes:  </label> &emsp;
                    <form>
                      <input  type="month" value="Buscar..." onfocus="if (this.value == 'Buscar...') {this.value = '';}" onblur="if (this.value == '') {this.value = 'Buscar...';}" />
