...
function ChapterTitle($label)
{
    ...
    $this->SetX((210-$w)/2);
    // Título
    $this->Cell($w,6,"Libro Mayor  $label",0,1,'C');
    // Salto de línea
    $this->Ln(4);
}
...
$pdf->PrintChapter(date(" m "));//fpdf/tutorial/20k_c1.txt
//$pdf->PrintChapter(date("d / m / y"));PARA QUE EN LA SIGUINETE PAGINA APARESCA ELTITULO OT5RA VEZ


// Títulos de las columnas
$header = array('Mes', 'Cuenta', 'Total Debe', 'Total Haber','Total Cuenta');
// Carga de datos
