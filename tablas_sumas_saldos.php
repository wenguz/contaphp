...
function ChapterTitle($label,$fecha)
{
    ...
    $this->SetX((210-$w)/2);
    // Título
    $this->Cell($w,6,"Balance de Comprobacion de Sumas y Saldos",0,1,'C');
    $this->Cell($w,6,"01/01/$fecha a  ".date("d/m/y"),0,1,'C');
    // Salto de línea
    $this->Ln(4);
}
...
$header = array('Codigo', 'Cuenta', 'Cargos', 'Abonos','Deudor','Acreedor');
// Carga de datos
$data = $pdf->LoadData('reportes_txt/sum_sald.txt');
