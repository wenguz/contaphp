                       ...
                       <?php
                        ...
                        if(isset($_POST['registrar_usuario']))
                        {
                            ...
                            else
                            {
                                ...
                                {
                                    if($result->user == $_POST['nuevo_usuario'])
                                    {
                                        $verificar_usuario = 1;
                                    }
                                }
                                ...
                                if($verificar_usuario == 0)
                                {
                                  ...
                                  $sql = "INSERT INTO usuario(id_usuario, nombre_usuario, ap_paterno_usuario, ap_materno_usuario, ci_usuario, user, password, estado) VALUES ('$id_usuario','$nombre_usuario' , '$ap_paterno_usuario', '$ap_materno_usuario', '$ci_usuario', '$user', '$password', 'ACTIVO');";
                                  ...
                                  $sq="INSERT INTO empleado_usuario (id_empleado_usuario, id_empleado, id_usuario) VALUES ('$id_empleado_usuario', '$id_empleado','$id_usuario')";
                                  mysqli_query($con,$sq);
